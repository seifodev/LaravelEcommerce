...
class productDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('action', 'admin.products.action.edit')
            ->editColumn('updated_at', function ($product) {
                return $product->updated_at ?  $product->updated_at->diffForHumans() : NULL;
            })
            ->editColumn('created_at', function ($product) {
                return $product->created_at ?  $product->created_at->diffForHumans() : NULL;
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'data' => 'title',
                'name' => 'title',
                'title' => trans('admin.form.product_title')
            ],
            [
                'data' => 'created_at',
                'name' => 'created_at',
    ...
    protected static function btns()
    {
        return [
            'dom' => [
                ...
                'buttons' => [
                    ['text' => '<i class="fa fa-plus"></i>', 'className' => 'btn btn-primary', 'action' => 'function (){window.location.href = "' . route('products.create') . '"}'],
