...
class CountryDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('action', 'admin.countries.action.edit')
            ...
            ->editColumn('logo', 'admin.countries.action.logo')
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'data' => 'mob',
                'name' => 'mob',
                'title' => trans('admin.form.country_mob')
            ],
            [
                'data' => 'code',
                'name' => 'code',
                'title' => trans('admin.form.country_code')
            ],
            [
                'data' => 'logo',
                'name' => 'logo',
    ...
    protected static function btns()
    {
        return [
            'dom' => [
                ...
                'buttons' => [
                    ['text' => '<i class="fa fa-plus"></i>', 'className' => 'btn btn-primary', 'action' => 'function (){window.location.href = "' . route('countries.create') . '"}'],
