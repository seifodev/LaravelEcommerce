...
class CityDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('action', 'admin.cities.action.edit')
    ...
    {
        return $model->with('country:name_ar,name_en,id')->orderBy('id', 'desc');
    }
...
//            ->addCheckbox([])
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'data' => 'country.name_' . (lang() == 'ar' ? 'ar' : 'en'),
                'name' => 'country_id',
                'title' => trans('admin.table.country')
            ],
            [
                'data' => 'created_at',
                'name' => 'created_at',
    ...
    protected static function btns()
    {
        return [
            'dom' => [
                ...
                'buttons' => [
                    ['text' => '<i class="fa fa-plus"></i>', 'className' => 'btn btn-primary', 'action' => 'function (){window.location.href = "' . route('cities.create') . '"}'],
