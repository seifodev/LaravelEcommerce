        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('name_ar') ? 'has-error' : '' }}">
                ...
                <div class="col-md-8 col-lg-6">
                    {!! Form::text('name_ar', $state->name_ar, ['id' => 'inputNameAr', 'class' => 'form-control', 'required']) !!}
                </div>
            </div>
            ...
            <div class="form-group {{ $errors->has('name_en') ? 'has-error' : '' }}">
                ...
                <div class="col-md-8 col-lg-6">
                    {!! Form::text('name_en', $state->name_en, ['id' => 'inputNameEn', 'class' => 'form-control', 'required']) !!}
                </div>
            </div>
            ...
            <div class="form-group {{ $errors->has('country_id') ? 'has-error' : '' }}">
                ...
                <div class="col-md-8 col-lg-6">
                    {!! Form::select('country_id', $countries, $state->city->country->id, ['id' => 'inputCountry', 'class' => 'form-control', 'required']) !!}
                </div>
            </div>
            ...
            if(countryId)
            {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        var selects = '';
                        var old = '{{ old('city_id') }}';
                        var selected = '{{ $state->city->id }}';
                        for(let i = 0; i < response.length; i++) {
                            if(old == response[i].id || selected == response[i].id) {
