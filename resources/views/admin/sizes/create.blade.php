    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('department_id') ? 'has-error' : '' }}">
                ...
                <div class="col-md-8 col-lg-6">
                    {!! Form::hidden('department_id', old('department_id'), ['id' => 'departmentId']) !!}
            ...
            <div class="form-group {{ $errors->has('is_public') ? 'has-error' : '' }}">
                ...
                <div class="col-md-8 col-lg-6">
                    {!! Form::select('is_public', ['yes' => trans('admin.yes'), 'no' => trans('admin.no')], old('is_public'), ['id' => 'inputPublic', 'class' => 'form-control', 'required']) !!}
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        $('#departments').jstree({
            ...
            'core' : {
                'multiple': false,
                'data' : {!! departsJson(old('department_id')) !!},
            },
            'checkbox' : {
                'deselect_all': true,
                'three_state' : false,
