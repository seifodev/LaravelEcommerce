...
<head>
    ...
    <title>{{ isset($title) ? $title : __('admin.title') }}</title>
    ...
    @else
            <!-- Theme style (LTR MODE) -->
            <link rel="stylesheet" href="{{ url('/design/admin/') }}/dist/css/AdminLTE.min.css">
            <link rel="stylesheet" href="{{ url('/design/admin/') }}/dist/css/ltr.css">
    @endif
    ...
    <link href="{{ url('/design/admin/') }}/plugins/summernote/summernote.css" rel="stylesheet">

    <!-- Custom App Style -->
    <link rel="stylesheet" href="{{ url('/design/admin/') }}/dist/css/style.css">
    @stack('styles')
